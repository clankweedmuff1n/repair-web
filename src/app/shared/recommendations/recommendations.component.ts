...
@Component({
  ...
  template: `
    <div class="py-20 w-full flex flex-col justify-center items-center">
      <div class="max-w-7xl">

        <div class="row">
          <h5 class="pb-10 text-2xl text-center">Рекомендации</h5>
        </div>
        <div>
          <div class="col-12">
            <div class="glide">
              ...
              <div class="glide__bullets flex justify-center mt-10" data-glide-el="controls[nav]">
                <button
                  *ngFor="let i of recommendations; let idx = index"
                  class="glide__bullet"
                  [attr.data-glide-dir]="'=' + idx"
                ></button>
              </div>
            </div>
          </div>
